...
class NewtonRaphsonMethodUI:
    ...
    def create_ui(self, parent, result_frame):
        ...
        self.control_frame = tk.LabelFrame(self.frame, text="Newton-Raphson Method")
        ...
        self.initial_value_label = tk.Label(self.control_frame, text="Initial Value:")
        self.initial_value_label.pack(anchor="w")
        self.initial_value_entry = tk.Entry(self.control_frame, width=20)
        self.initial_value_entry.pack(anchor="w")
    ...
    def display_result(self, result):
        ...
        result_label = tk.Label(self.result_frame, text="Newton-Raphson Method Result", font=("Helvetica", 14, "bold"))
