...
class MatrixProductByVectorSumUI:
    ...
    def create_ui(self, parent, result_frame):
        ...
        self.add_vector_button = tk.Button(self.control_frame, text="Add Vector", command=self.add_vector)
        self.add_vector_button.pack(anchor="center", pady=10)

        self.calculate_button = tk.Button(self.control_frame, text="Calculate Matrix Product by Vector Sum", command=self.calculate)
